...
posnext.PointOfSale.Controller = class {
  ...
  add_ledger_balance_box() {
    ...
    const observer = new MutationObserver(async () => {
      ...
      if (customerSection) {
        const resetCustomerBtn = customerSection.querySelector(
          ".reset-customer-btn",
        );
  ...
  fetch_opening_entry(value) {
    return frappe.call(
      "posnext.posnext.page.posnext.point_of_sale.check_opening_entry",
      { user: frappe.session.user, value: value },
    );
  }
  ...
  create_opening_voucher() {
    ...
    const dialog = new frappe.ui.Dialog({
      ...
      primary_action: async function ({
        ...
        const method =
          "posnext.posnext.page.posnext.point_of_sale.create_opening_voucher";
